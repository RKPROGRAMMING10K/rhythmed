<footer class="cs_footer cs_style_1 cs_heading_color">
    <div class="cs_footer_logo_wrap" data-src="assets/img/footer_bg_1.svg">
        <div class="cs_footer_brand" data-src="assets/img/footer_logo_bg.svg">
            ...
            <h2 class="cs_footer_brand_text">RHYTHMED</h2>
        </div>
    </div>
                    ...
                    <div class="cs_footer_item">
                        ...
                        <ul class="cs_contact_widget">
                            <li>
                                ...
                                402, 4th floor, Archit's Sai Square, Tidke colony, Mumbai
                                Naka, Nashik 422002
                            </li>
                            <li>
                                <i class="cs_accent_bg">
                            ...
                            <li>
                                ...
                                <a href="mailto:rhythmedpharma@gmail.com" class="__cf_email__">rhythmedpharma@gmail.com</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="cs_footer_item">
                        <ul class="cs_menu_widget cs_mp0">
                            <li><a href="router.php?page=about">About Us</a></li>
                            <li><a href="router.php?page=product">Product</a></li>
                            <li><a href="router.php?page=gallery">Gallery</a></li>
                            <li><a href="router.php?page=csr">CSR</a></li>
                            <li><a href="router.php?page=contact">Contact Us</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="cs_footer_bottom_in">
                ...
                <div class="cs_copyright">
                    ...
                    &copy; All Rights Are Reserved to Rhythmed PVT.LTD. <br> Design by <a href="https://www.dynografx.com"><span>Dynografx</span></a>
                </div>
            </div>
        </div>
    </div>
